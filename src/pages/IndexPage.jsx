            ...
            <AppLayout>
                ...
                <Grid p={3} mt={2} borderRadius={5} bgcolor='primary.blue' className='animate__animated animate__fadeInRight box-shadow'>
                    <Typography variant='h6' color='white'>
                        ...
                        My career journey has equipped me with a versatile skill set, including proficiency in technologies such as React.js, Node.js, Firebase and Scikit-learn, and programming languages such as Python, R, Swift and PHP. I'm particularly passionate about web development and machine learning, where I've demonstrated a track record of stunning web apps and projects that you can explore in my portfolio. <br></br> <br></br>
